import { searchOpenFoodFacts } from './openFoodFactsClient';
...
describe('searchOpenFoodFacts', () => {
  ...
  it('skips products missing a required macro (kcal, protein, carbs, or fat)', async () => {
    fetchMock.mockResolvedValue(
      jsonResponse({
        products: [
          { product_name: 'Missing fat', code: '1', nutriments: { 'energy-kcal_100g': 100, proteins_100g: 5, carbohydrates_100g: 10 } },
